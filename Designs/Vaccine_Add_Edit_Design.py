...
class Ui_winVaccineAddEdit(object):
    def setupUi(self, winVaccineAddEdit):
        ...
        self.lblDateOAppointment = QtWidgets.QLabel(winVaccineAddEdit)
        self.lblDateOAppointment.setGeometry(QtCore.QRect(38, 52, 145, 20))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(12)
        self.lblDateOAppointment.setFont(font)
        self.lblDateOAppointment.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.lblDateOAppointment.setStyleSheet("")
        self.lblDateOAppointment.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.lblDateOAppointment.setObjectName("lblDateOAppointment")
...
"color: rgb(74, 74, 74);")
        ...
        self.dtDateOfVaccination.setStyleSheet("background-color: rgb(232, 232, 232);\n"
"color: rgb(74, 74, 74);")
        ...
        self.cbDateOfVaccination = QtWidgets.QCheckBox(winVaccineAddEdit)
        self.cbDateOfVaccination.setGeometry(QtCore.QRect(198, 84, 21, 17))
        self.cbDateOfVaccination.setStyleSheet("background-color: rgb(232, 232, 232);\n"
"")
        self.cbDateOfVaccination.setText("")
        self.cbDateOfVaccination.setObjectName("cbDateOfVaccination")
        self.btnNameofVaccine = QtWidgets.QToolButton(winVaccineAddEdit)
        self.btnNameofVaccine.setGeometry(QtCore.QRect(414, 23, 27, 21))
        self.btnNameofVaccine.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.btnNameofVaccine.setObjectName("btnNameofVaccine")
    ...
    def retranslateUi(self, winVaccineAddEdit):
        ...
        self.lblDateOAppointment.setText(_translate("winVaccineAddEdit", "Date of Appointment:"))
        ...
        self.btnNameofVaccine.setText(_translate("winVaccineAddEdit", "..."))
